...
if [ "$#" -ne 3 ]; then
    ...
    echo "Uso: ./setup_repo_final.sh SEU_TOKEN \"Seu Nome\" seu.email@exemplo.com"
    exit 1
fi
...
check_error "Falha ao configurar branch main"
...
# Configurar branch local para track origin/main
echo "Configurando tracking da branch..."
git branch --set-upstream-to=origin/main main 2>/dev/null || true

# Push para GitHub com -f para forçar o push inicial
