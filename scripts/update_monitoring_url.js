...
// Função principal
const updateMonitoringUrlField = async () => {
  let client;
  
  try {
    console.log('Iniciando adição do campo de URL de monitoramento...');
    
    // Verificar se o arquivo SQL existe
    const sqlFilePath = path.join(rootDir, 'scripts', 'add_monitoring_url_field.sql');
    ...
    console.log('Adicionando campo de URL de monitoramento...');
