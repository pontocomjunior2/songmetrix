    ...
    return (
      <div className="w-full">
        ...
        <div className="relative rounded-lg">
          {icon && (
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none group">
              <span className="text-gray-400 group-focus-within:text-[#1a3891] transition-colors">{icon}</span>
            </div>
          )}
          <input
            ref={ref}
    ...
    return (
      <div className="relative">
        ...
        >
          {showPassword ? (
            <svg
              className="h-5 w-5 text-gray-400 hover:text-[#1a3891] transition-colors"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
            >
