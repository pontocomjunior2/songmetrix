...
BEGIN
    ...
    PERFORM net.http_post(
        url := 'https://[PROJECT_REF].supabase.co/functions/v1/user-webhook',
...
-- Nota: Substitua [PROJECT_REF] pelo ID real do seu projeto Supabase antes de executar esta migração 